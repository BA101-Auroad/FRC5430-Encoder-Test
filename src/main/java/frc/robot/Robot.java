...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
      ...
      SmartDashboard.putNumber("encoderValue", motor1.getSelectedSensorPosition());
      SmartDashboard.putNumber("encoderSpeed", motor1.getSelectedSensorVelocity());

      SmartDashboard.putNumber("encoderRotations", motor1.getSelectedSensorPosition() / 2048);
      SmartDashboard.putNumber("encoderDegrees", (motor1.getSelectedSensorPosition() / 2048) * 360);
